                            ...
                            <span class="">
                                <script type="text/javascript">
                                    farbbibliothek = new Array();
                                            ...
                                            text = "Hệ Thống WebSite Thương Mại AnPhat";
                                            string2array(text);
                                            divserzeugen();</script>
                            </span>
                        </h2>
    ...
    <body class="padTop53">       
        <c:if test="${not empty username}">
            <div id="wrap" >
                    ...
                    <nav class="navbar navbar-inverse navbar-fixed-top " style="padding-top: 10px;">
                        ...
                        <header class="navbar-header">
                            <a href="index.htm" class="navbar-brand" style="margin-top: -9px;">
                                <img src="assets/img/anphatpc.png" alt="" height="45" />
                            </a>
                        </header>
                ...
                <div id="left" >
                    <div class="media user-media well-small">
                        <a class="user-link" href="#">
                            <img class="media-object img-thumbnail user-img" style="width: 64px; height: 64px;" alt="${sessionScope.username}" title="${sessionScope.username}" src="assets/img/40168585_1452917338186218_4865230925891371008_n.jpg" />
                        </a>
                        <br />
                    ...
                    <ul id="menu" class="collapse">
                        ...
                        <li class="panel">
                            <a href="listCate.htm?page=1" >
                                <i class="icon-th-list"></i> Loại sản phẩm
                            </a>                   
                        </li>
                        <li class="panel">
                            <a href="listP.htm?page=1" >
                                <i class="icon-trophy"></i> Sản phẩm
                            </a>                   
                        </li>
                        <li class="panel">
                            <a href="listPro.htm?page=1" >
                                <i class="icon-indent-left"></i> Nhà sản xuất
                            </a>                   
                        </li>
                        <li class="panel">
                            <a href="listO.htm?page=1" >
                                <i class="icon-shopping-cart"></i> Đơn hàng
                            </a>                   
                        </li>
                        <li class="panel">
                        ...
                        <li class="panel">
                            <a href="listCo.htm?page=1" >
                                <i class="icon-book"></i> Tin tức
                            </a>                   
                        </li>
                        <li class="panel">
                        ...
                        <li class="panel">
                            <a href="listReport.htm" >
                                <i class="icon-bar-chart"></i> Thống kê
                            </a>                   
                        </li>
                        <li class="panel">
                ...
                <div id="footer">
                    <p>DungLT18@FSOFT.COM.VN &nbsp;2018</p>
                </div>
        </c:if>
