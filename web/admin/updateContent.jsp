...
<mt:layout title="Update Content Page">   
                ...
                <div class="col-lg-12">
                    <div class="box">
                        ...
                        <div id="collapseOne" class="accordion-body collapse in body">
                            <spring:form action="updateContent.htm" class="form-horizontal" commandName="co" method="post">
                                <spring:hidden path="contentID"/>
                                    ...
                                    <div class="col-lg-10">
                                        <div class="col-md-4">
                                            <div class="fileupload fileupload-new" data-provides="fileupload" style="margin-left: -15px;">
                                                <div class="fileupload-new thumbnail"><img src="${co.image}" width="220px;" height="175px;" alt=""></div>
