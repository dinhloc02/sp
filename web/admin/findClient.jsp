        ...
        <div id="sidebar" class="span3">
            ...
            <c:if test="${empty listProduct}">
                <div class="alert alert-block alert-error fade in">
                    ...
                    <strong>Không có sản phẩm nào tên "${currentName}" tồn tại !!!</strong>
                </div>
            </c:if>
            <c:if test="${not empty listProduct || listProduct.size()!=0}">
                <h3> Kết quả tìm kiếm cho "${currentName}" </h3>	
                <hr class="soft"/>
                <div class="control-group">
                    <div class="controls">
                        <a style="margin: -10px 5px 0 0;">&nbsp;</a>
                        <a href="findClientSortPriceAsc.htm?name=${currentName}&&page=1" class="pull-right btn btn-success btn-xs" style="margin: -10px 0 0 0;">Giá tăng dần</a>
                        <a href="findClientSortPriceDesc.htm?name=${currentName}&&page=1" class="pull-right btn btn-success btn-xs" style="margin: -10px 5px 0 0;">Giá giảm dần</a>
                        <a href="findClientSortNameAsc.htm?name=${currentName}&&page=1" class="pull-right btn btn-success btn-xs" style="margin: -10px 5px 0 0;">Tên tăng dần</a>
                        <a href="findClientSortNameDesc.htm?name=${currentName}&&page=1" class="pull-right btn btn-success btn-xs" style="margin: -10px 5px 0 0;">Tên giảm dần</a>
                    </div>
                </div>
                            ...
                            <div class="row">	  
                                ...
                                <div class="span3 alignR">
                                    <form class="form-horizontal qtyFrm">
                                        ...
                                        <a href="them-vao-gio-hang.htm?productID=${p.productID}&&cateId=${p.categoryID.categoryID}&&name=${currentName}&&page=${currentPage}&&back=${back}" class="btn btn-large btn-primary"> Thêm <i class=" icon-shopping-cart"></i></a>
                                    ...
                                    <div class="thumbnail">
                                        ...
                                        <div class="caption">
                                            ...
                                            <h4 style="text-align:center">
                                                ...
                                                <a class="btn" href="them-vao-gio-hang.htm?productID=${p.productID}&&cateId=${p.categoryID.categoryID}&&name=${currentName}&&page=${currentPage}&&back=${back}">Thêm 
                            ...
                            <ul class="pagination">
                                <c:if test="${currentPage != 1}">
                                    <li class="paginate_button previous">
                                        <a href="${link}.htm?name=${currentName}&&page=${currentPage-1}">Previous</a>
                                    </li>
                                </c:if>
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <li class="paginate_button">
                                                <a href="${link}.htm?name=${currentName}&&page=${i}">${i}</a>
                                            </li>
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                                <c:if test="${currentPage lt noOfPages}">
                                    <li class="paginate_button next">
                                        <a href="${link}.htm?name=${currentName}&&page=${currentPage+1}">Next</a>
                                    </li>
                                </c:if>
                            </ul>
                        </div>
