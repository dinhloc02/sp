                    ...
                    <div id="div-5" class="accordion-body collapse in body">
                        <div class="form-group row">
                            <div class="col-lg-9" style="margin-bottom: 3px;">
                                <a href="listOrdersStatus1.htm?page=1" class="btn btn-danger btn-xs">Chưa hoàn thành đơn hàng</a>
                                <a href="listOrdersStatus2.htm?page=1" class="btn btn-warning btn-xs">Đang trên đường đi</a>
                                <a href="listOrdersStatus3.htm?page=1" class="btn btn-success btn-xs">Đã hoàn thành đơn hàng</a>
                                <a href="listO.htm?page=1" class="btn btn-primary btn-xs">Tất cả đơn hàng</a>
                            </div>
                            <div class="col-lg-3">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 150px;">Ngày Gửi Đơn</th>
                                            <th style="width: 150px;">Trạng Thái</th>
                                            <th style="width: 150px;">Thao Tác</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <c:forEach items="${listOrdersStatus1}" var="o">
                                            <tr>
                                                <td>${o.shipName}</td>
                                                <td>${o.shipMobile}</td>
                                                <td>${o.shipAdress}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <c:if test="${o.status == 2}">
                                                        <a class='btn btn-warning btn-xs'>Đang trên đường đi</a>
                                                    </c:if>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="deleteOrder.htm?orderID=${o.orderID}&&page=${currentPage}&&status=1" class="btn btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa đơn hàng này?')"><i class="icon-remove icon-white"></i></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                        ...
                                        <ul class="pagination">
                                            <c:if test="${currentPage != 1}">
                                                <li class="paginate_button previous">
                                                    <a href="listOrdersStatus1.htm?page=${currentPage-1}">Previous</a>
                                                </li>
                                            </c:if>
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <li class="paginate_button">
                                                            <a href="listOrdersStatus1.htm?page=${i}">${i}</a>
                                                        </li>
                                                    </c:otherwise>
                                                </c:choose>
                                            </c:forEach>
                                            <c:if test="${currentPage lt noOfPages}">
                                                <li class="paginate_button next">
                                                    <a href="listOrdersStatus1.htm?page=${currentPage+1}">Next</a>
                                                </li>
                                            </c:if>
                                        </ul>
                                    </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h5 class="modal-title" id="myModalLabel">Dữ liệu đơn hàng</h5>
                                </div>
