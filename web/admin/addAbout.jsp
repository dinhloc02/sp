...
<mt:layout title="Insert About Page">   
                ...
                <div class="col-lg-12">
                    <div class="box">
                        <header>
                            ...
                            <h5>Màn hình nhập dữ liệu</h5><div class="toolbar">
                                <ul class="nav">
                                    <li>
                                        <div class="btn-group">
                        ...
                        <div id="collapseOne" class="accordion-body collapse in body">
                            <spring:form action="addAbout.htm" class="form-horizontal" commandName="a" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <spring:input path="createDate" type="date" id="today" name="createDate" placeholder="" class="form-control" readonly="true"/>
