    ...
    <jsp:attribute name="content">
        <div id="sidebar" class="span3">
            ...
            <div class="span9">
                ...
                <h3> Đăng ký ${notificationsSuccessfully} ${notificationsError}</h3>
            <div class="well">
                <spring:form action="addIndexUser.htm" class="form-horizontal" commandName="u" method="post">
                    <h4>Nhập thông tin đầy đủ</h4>
                    ...
                    <div class="control-group" style="text-align: center;">
                        <div class="controls">
                            <a href="initIndexAddUser.htm" class="btn btn-danger"> Làm mới</a>
                            <input class="btn btn-success" id="btn" type="submit" value="Đăng ký" />
                        </div>
                    </div>		
                </spring:form>
            </div>
