                        ...
                        <div class="row">	  
                            ...
                            <div class="span3 alignR">
                                <form class="form-horizontal qtyFrm">
                                    ...
                                    <a href="them-vao-gio-hang.htm?productID=${p.productID}&&cateId=${p.categoryID.categoryID}&&page=${currentPage}&&back=9" class="btn btn-large btn-primary"> Thêm <i class=" icon-shopping-cart"></i></a>
                                ...
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        ...
                                        <h4 style="text-align:center">
                                            ...
                                            <a class="btn" href="them-vao-gio-hang.htm?productID=${p.productID}&&cateId=${p.categoryID.categoryID}&&page=${currentPage}&&back=9">Thêm 
                        ...
                        <ul class="pagination">
                            <c:if test="${currentPage != 1}">
                                <li class="paginate_button previous">
                                    <a href="productClient.htm?page=${currentPage-1}">Previous</a>
                                </li>
                            </c:if>
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <li class="paginate_button">
                                            <a href="productClient.htm?page=${i}">${i}</a>
                                        </li>
                                    </c:otherwise>
                                </c:choose>
                            </c:forEach>
                            <c:if test="${currentPage lt noOfPages}">
                                <li class="paginate_button next">
                                    <a href="productClient.htm?page=${currentPage+1}">Next</a>
                                </li>
                            </c:if>
                        </ul>
                    </div>
