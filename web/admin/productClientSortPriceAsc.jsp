        ...
        <div id="sidebar" class="span3">
            ...
            <div class="span9">
                ...
                <div class="tab-content">
                    ...
                    <c:forEach items="${listProductSortPriceAsc}" var="p">
                        <div class="row">	  
                            <div class="span2">
                        ...
                        <ul class="pagination">
                            <c:if test="${currentPage != 1}">
                                <li class="paginate_button previous">
                                    <a href="productClientSortPriceAsc.htm?page=${currentPage-1}">Previous</a>
                                </li>
                            </c:if>
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <li class="paginate_button">
                                            <a href="productClientSortPriceAsc.htm?page=${i}">${i}</a>
                                        </li>
                                    </c:otherwise>
                                </c:choose>
                            </c:forEach>
                            <c:if test="${currentPage lt noOfPages}">
                                <li class="paginate_button next">
                                    <a href="productClientSortPriceAsc.htm?page=${currentPage+1}">Next</a>
                                </li>
                            </c:if>
                        </ul>
                    </div>
