...
<mt:layout title="Update Product Page">   
                ...
                <div class="col-lg-12">
                    <div class="box">
                        ...
                        <div id="collapseOne" class="accordion-body collapse in body">
                            <spring:form action="updateProduct.htm" class="form-horizontal" commandName="p" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <spring:input path="code" type="text" id="code" name="code" placeholder="" class="form-control"/>
                                    ...
                                    <div class="col-lg-10">
                                        <div class="col-md-4">
                                            <div class="fileupload fileupload-new" data-provides="fileupload" style="margin-left: -15px;">
                                                <div class="fileupload-new thumbnail"><img src="${p.image}" width="220px;" height="175px;" alt=""></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        &nbsp;&nbsp;
                                        <spring:radiobutton path="special" value="true"/> Không
                                    </div>
                                </div>
                                <div class="form-group">
