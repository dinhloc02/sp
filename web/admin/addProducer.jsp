                        ...
                        <div id="collapseOne" class="accordion-body collapse in body">
                            <spring:form action="addProducer.htm" class="form-horizontal" commandName="pro" method="post">
                                <div class="form-group">
                                    <label for="text1" class="control-label col-lg-2">Tên Nhà Sản Xuất</label>
                                    <div class="col-lg-10">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-lg-2">Logo Nhà Sản Xuất</label>
                                    <div class="col-lg-10">
                                ...
                                <div class="form-group">
                                    <label for="text1" class="control-label col-lg-2">Email Nhà Sản Xuất</label>
                                    <div class="col-lg-10">
