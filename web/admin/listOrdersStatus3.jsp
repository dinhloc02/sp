                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <c:forEach items="${listOrdersStatus3}" var="o">
                                            <tr>
                                                <td>${o.shipName}</td>
                                                <td>${o.shipMobile}</td>
                                                <td>${o.shipAdress}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="deleteOrder.htm?orderID=${o.orderID}&&page=${currentPage}&&status=3" class="btn btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa đơn hàng này?')"><i class="icon-remove icon-white"></i></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                        ...
                                        <ul class="pagination">
                                            <c:if test="${currentPage != 1}">
                                                <li class="paginate_button previous">
                                                    <a href="listOrdersStatus3.htm?page=${currentPage-1}">Previous</a>
                                                </li>
                                            </c:if>
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <li class="paginate_button">
                                                            <a href="listOrdersStatus3.htm?page=${i}">${i}</a>
                                                        </li>
                                                    </c:otherwise>
                                                </c:choose>
                                            </c:forEach>
                                            <c:if test="${currentPage lt noOfPages}">
                                                <li class="paginate_button next">
                                                    <a href="listOrdersStatus3.htm?page=${currentPage+1}">Next</a>
                                                </li>
                                            </c:if>
                                        </ul>
                                    </div>
