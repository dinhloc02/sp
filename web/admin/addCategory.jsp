...
<mt:layout title="Insert Category Page">   
                ...
                <div class="col-lg-12">
                    <div class="box">
                        ...
                        <div id="collapseOne" class="accordion-body collapse in body">
                            <spring:form action="addCategory.htm" class="form-horizontal" commandName="cate" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <spring:input path="createDate" readonly="true" type="date" id="today" name="createDate" placeholder="" class="form-control"/>
