...
public class FeedBacksController {
    ...
    public String insertFeedBack(@Valid @ModelAttribute("fb") FeedBacksInsert fb, BindingResult result, RedirectAttributes attributes, Model model) {
        ...
        if (blInsert) {
            attributes.addFlashAttribute("notificationsSuccessfully", "Phản hồi của bạn đã được gửi thành công! Xin chân thành cảm ơn sự đóng góp ý kiến của bạn đối với công ty!");
